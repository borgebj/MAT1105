...
\begin{enumerate}
    ...
    \item Hvis A har et pivotelement i hver rad så har $Ax = b$ alltid løsninger
...
\begin{pmatrix}[ccc|c]
    ...
    0&0&2&-8
\end{pmatrix}
\eqqto{\frac{2}{3}II\\\\ \frac{1}{2}III}
\begin{pmatrix}[ccc|c]
    1&1/2&3/2&1/2\\
    0&1&11/3&-23/3\\
    0&0&1&-4
...
\begin{pmatrix}[ccc|c]
    ...
    0&0&1&-4
\end{pmatrix}
\eqqto{II-\frac{11}{3}III}
\begin{pmatrix}[ccc|c]
    1&0&0&3\\
    0&1&0&7\\
    0&0&1&-4
\end{pmatrix}
\qquad \mathbf{x = \vect{3\\7\\-4} = e}
\)
\\\\\\
Hva kan vi si om løsningende?
\\\\\\\\
...
\([1,2]\times[1,2], x\geq y \eqq \{(1, 1), (2, 1), (2,2)\} \eqq b\)
