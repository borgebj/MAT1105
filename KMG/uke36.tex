...
A^c \cap B^c = B^c \cap A^c = (-\infty, 1) \cap [0, \infty) = 1\)
...
\section*{Kapittel 5}
\subsection*{Oppgave 5.1}
\textbf{Teorem:}
\textit{Hvis n er et tall som er delelig med 4, så er n et partall.} 

\underline{Vi vet:} $n$ er delelig med 4.\\
\underline{Vil vise:} $n$ er et partall.

\textbf{Definisjon:} Et partall er et tall som kan skrives på formen $2n$ hvor $n \in \mathbb{N}$

Siden $n$ er delelig med 4, kan den skrives på formen $n = 4m$ for $m \in  \mathbb{N}$ \\\\
$n = 4m$ er lik $n =2 * 2 * m$, og v i kan skrive $n = 2 * l$ hvor $l = 2m$
\\\\
Dette viser at n er et partall, fordi den er på formen $2n$

\subsection*{Oppgave 5.2}


\subsection*{Oppgave 5.3}


\subsection*{Oppgave 5.4}


\subsection*{Oppgave 5.5}


\subsection*{Oppgave 5.6}


\subsection*{Oppgave 5.7}


\subsection*{Oppgave 5.8}
